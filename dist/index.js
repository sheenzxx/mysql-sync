    ...
    program
        ...
        try {
            ...
            if (options.config) {
                ...
                if (cliOpts.sourceHost !== 'localhost')
                    config.source.host = cliOpts.sourceHost;
                if (cliOpts.targetHost !== 'localhost')
                    config.target.host = cliOpts.targetHost;
                if (cliOpts.sourcePort !== 3306)
                    config.source.port = cliOpts.sourcePort;
                if (cliOpts.targetPort !== 3306)
                    config.target.port = cliOpts.targetPort;
            }
            else {
