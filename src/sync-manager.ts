...
export class SyncManager extends EventEmitter {
  ...
  private activeObjects: Set<string> = new Set(); // "db.table" keys
  ...
  async resolveSyncObjects(): Promise<SyncObject[]> {
  ...
  private isExcluded(database: string, table: string): boolean {
